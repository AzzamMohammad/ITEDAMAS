...
class MyDropdownListWithFunction extends StatelessWidget {
  List<String> items = [];
  ...
  MyDropdownListWithFunction({required this.selectedValue, required this.items , required this.function});
